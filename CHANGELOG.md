...
- Fifth sourced target batch (ADR-012) — **Faulhaber's theorem: power sums as polynomials in the triangular number T = ∑k** (difficulty 2–4): `sum-range-sq-triangular-form` (3∑k² = T(2n+1)), `sum-range-pow-four-triangular-form` (15∑k⁴ = T(2n+1)(3n²+3n−1)), `sum-range-pow-five-faulhaber-triangular` (3∑k⁵ = T²(4T−1)), and `sum-range-pow-seven-faulhaber-triangular` (3∑k⁷ = T²(6T²−4T+1)). Each compounds on a *proved* closed form (`deps≜`) — re-expressing it in T — so it reveals the Faulhaber structure: even powers carry the factor (2n+1), odd powers reduce to pure polynomials in T. The capstone: the p=5 and p=7 rungs **sum to the previous batch's crown** — 3∑k⁵ + 3∑k⁷ = T²(4T−1) + T²(6T²−4T+1) = 6T⁴, so ∑k⁵+∑k⁷ = 2T⁴ falls out as a corollary. Every identity numerically verified before sourcing; type-checks against pinned mathlib (rev c5ea00351c28); absence machine-checked (only the general Bernoulli `sum_range_pow` is present, no T-forms). Board: 12 open / 60 proved / 73 total; gate-b DAG-valid.
