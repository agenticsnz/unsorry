...
- Sixth sourced target batch (ADR-012) — **fourth-power congruences → p⁴ ≡ 1 (mod 240)**, a depth-2 dependency tree extending the proved 24∣p²−1 chain (binto-labs) one power up: three leaves `odd-fourth-power-mod-sixteen` (odd n → n⁴%16=1, compounds on proved `odd-sq-mod-eight`), `fourth-power-mod-three` (3∤n → n⁴%3=1, compounds on proved `sq-mod-three`), `fourth-power-mod-five` (5∤n → n⁴%5=1, Fermat at 5), feeding the root `prime-fourth-power-mod-240` (prime p>5 → p⁴%240=1) via CRT over the coprime moduli 16·3·5. Difficulty 2–4. Two of the three leaves reuse already-proved library congruence lemmas; the root is the named competition gem one power above the p²-mod-24 result. Every case numerically verified (incl. 59 primes for the root) before sourcing; all four type-check against pinned mathlib (rev c5ea00351c28); absence machine-checked (the `240` flag is the E₄ Eisenstein-series coefficient, not a congruence). Board: 11 open / 61 proved / 73 total; gate-b DAG-valid.
