...
**4757 verified proofs · 4448 attributed · 309 historical/unknown · 458 logged terminal runs.**
...
| Provider attempts | 584 |
| Failed attempts | 490 |
| Attempt yield | 16.1% |
| Recorded run time | 122h 37m |
| Median / p90 run time | 7m 48s / 32m 6s |
| Verified successes per recorded hour | 0.77 |
| Proofs with run telemetry | 94 (2.0%) |

## Work Queue

**5019 goals · 3389 archived · 16 blocked · 225 open · 1380 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 233 | 75 | 32.2% | 233 | 7m 9s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 286 | 5.2% | 216 | 2897.1 | 314310 |
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 2373 | 2372 | 1 | 52 | 100.0% | 2376 | 0.0 | 296925 |
...
**4448 explicit solver credits · 308 inferred git credits · 1 uncredited proof records.**

Git add-author attribution covers 4757 of 4757 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2371 | 52 | 100.0% | 0 | 1 | 0s | — |
