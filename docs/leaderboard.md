...
**4705 verified proofs · 4396 attributed · 309 historical/unknown · 413 logged terminal runs.**
...
| Run success rate | 11.9% |
| Provider attempts | 539 |
| Failed attempts | 490 |
| Attempt yield | 9.1% |
| Recorded run time | 122h 37m |
| Median / p90 run time | 8m 37s / 32m 11s |
| Verified successes per recorded hour | 0.40 |
| Proofs with run telemetry | 49 (1.0%) |

## Work Queue

**4967 goals · 3355 archived · 16 blocked · 225 open · 1362 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 188 | 30 | 16.0% | 233 | 8m 41s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 286 | 5.2% | 216 | 2856.6 | 310260 |
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 2321 | 2320 | 1 | 7 | 100.0% | 2324 | 0.0 | 290425 |
...
**4396 explicit solver credits · 308 inferred git credits · 1 uncredited proof records.**

Git add-author attribution covers 4705 of 4705 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2319 | 7 | 100.0% | 0 | 1 | 0s | — |
