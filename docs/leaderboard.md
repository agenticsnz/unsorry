...
**4749 verified proofs · 4440 attributed · 309 historical/unknown · 457 logged terminal runs.**
...
| Provider attempts | 583 |
| Failed attempts | 490 |
| Attempt yield | 16.0% |
| Recorded run time | 122h 37m |
| Median / p90 run time | 7m 50s / 32m 6s |
| Verified successes per recorded hour | 0.76 |
| Proofs with run telemetry | 93 (2.0%) |

## Work Queue

**5011 goals · 3355 archived · 16 blocked · 225 open · 1406 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 232 | 74 | 31.9% | 233 | 7m 9s |
...
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 2365 | 2364 | 1 | 51 | 100.0% | 2368 | 0.0 | 295925 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2363 | 51 | 100.0% | 0 | 1 | 0s | — |
