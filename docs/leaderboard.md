...
**4667 verified proofs · 4358 attributed · 309 historical/unknown · 545 logged terminal runs.**
...
| Median / p90 run time | 5m 42s / 32m 4s |
| Verified successes per recorded hour | 1.48 |
| Proofs with run telemetry | 181 (3.9%) |

## Work Queue

**4929 goals · 3185 archived · 16 blocked · 225 open · 1494 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 320 | 162 | 50.6% | 233 | 3m 53s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 286 | 5.2% | 216 | 2822.4 | 306840 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 20.7 | 288045 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2283 | 2282 | 1 | 139 | 100.0% | 2286 | 0.0 | 285675 |
...
**4358 explicit solver credits · 308 inferred git credits · 1 uncredited proof records.**

Git add-author attribution covers 4667 of 4667 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2281 | 139 | 100.0% | 0 | 1 | 0s | — |
