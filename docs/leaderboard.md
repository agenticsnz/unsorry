...
**4677 verified proofs · 4368 attributed · 309 historical/unknown · 555 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 191 |
| Failed terminal runs | 364 |
| Decomposed after failure | 33 |
| Failed without decomposition | 331 |
| Run success rate | 34.4% |
| Provider attempts | 681 |
| Failed attempts | 490 |
| Attempt yield | 28.1% |
| Recorded run time | 122h 37m |
| Median / p90 run time | 5m 32s / 32m 4s |
| Verified successes per recorded hour | 1.56 |
| Proofs with run telemetry | 191 (4.1%) |

## Work Queue

**4939 goals · 3185 archived · 16 blocked · 225 open · 1504 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 330 | 172 | 52.1% | 233 | 3m 35s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 286 | 5.2% | 216 | 2831.4 | 307740 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 20.7 | 288045 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2293 | 2292 | 1 | 149 | 100.0% | 2296 | 0.0 | 286925 |
...
**4368 explicit solver credits · 308 inferred git credits · 1 uncredited proof records.**

Git add-author attribution covers 4677 of 4677 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2291 | 149 | 100.0% | 0 | 1 | 0s | — |
