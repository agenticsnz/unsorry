...
**4705 verified proofs · 4396 attributed · 309 historical/unknown · 583 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 219 |
| Failed terminal runs | 364 |
| Decomposed after failure | 33 |
| Failed without decomposition | 331 |
| Run success rate | 37.6% |
| Provider attempts | 709 |
| Failed attempts | 490 |
| Attempt yield | 30.9% |
| Recorded run time | 122h 37m |
| Median / p90 run time | 4m 53s / 32m 2s |
| Verified successes per recorded hour | 1.79 |
| Proofs with run telemetry | 219 (4.7%) |

## Work Queue

**4967 goals · 3185 archived · 16 blocked · 225 open · 1532 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 358 | 200 | 55.9% | 233 | 2m 4s |
...
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 2321 | 2320 | 1 | 177 | 100.0% | 2324 | 0.0 | 290425 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2319 | 177 | 100.0% | 0 | 1 | 0s | — |
