...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 657 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 294 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 44.8% |
| Provider attempts | 781 |
| Failed attempts | 487 |
| Attempt yield | 37.6% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 4m 1s / 31m 57s |
| Verified successes per recorded hour | 2.43 |
| Proofs with run telemetry | 294 (6.4%) |

## Work Queue

**4870 goals · 3015 archived · 15 blocked · 224 open · 1607 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 432 | 275 | 63.7% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 252 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 252 | 100.0% | 0 | 1 | 0s | — |
