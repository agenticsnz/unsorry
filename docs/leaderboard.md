...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 691 logged terminal runs.**
...
| Run success rate | 47.5% |
| Provider attempts | 815 |
| Failed attempts | 487 |
| Attempt yield | 40.2% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 3m 42s / 31m 55s |
| Verified successes per recorded hour | 2.71 |
| Proofs with run telemetry | 328 (7.1%) |

## Work Queue

**4870 goals · 2981 archived · 15 blocked · 224 open · 1641 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 466 | 309 | 66.3% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 286 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 286 | 100.0% | 0 | 1 | 0s | — |
