...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 623 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 260 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 41.7% |
| Provider attempts | 747 |
| Failed attempts | 487 |
| Attempt yield | 34.8% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 4m 18s / 31m 58s |
| Verified successes per recorded hour | 2.15 |
| Proofs with run telemetry | 260 (5.6%) |

## Work Queue

**4870 goals · 3049 archived · 15 blocked · 224 open · 1573 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 398 | 241 | 60.6% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 218 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 218 | 100.0% | 0 | 1 | 0s | — |
