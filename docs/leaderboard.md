...
**4447 verified proofs · 4139 attributed · 308 historical/unknown · 1250 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 893 |
| Failed terminal runs | 357 |
| Decomposed after failure | 29 |
| Failed without decomposition | 328 |
| Run success rate | 71.4% |
| Provider attempts | 1367 |
| Failed attempts | 474 |
| Attempt yield | 65.3% |
| Recorded run time | 114h 43m |
| Median / p90 run time | 0s / 31m 20s |
| Verified successes per recorded hour | 7.78 |
| Proofs with run telemetry | 893 (20.1%) |

## Work Queue

**4704 goals · 2199 archived · 12 blocked · 224 open · 2260 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 1030 | 874 | 84.9% | 227 | 0s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 280 | 5.4% | 216 | 2664.0 | 291000 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 18.9 | 287865 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2066 | 2065 | 1 | 853 | 100.0% | 2069 | 0.0 | 258550 |
...
**4139 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 4447 of 4447 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2064 | 853 | 100.0% | 0 | 1 | 0s | — |
