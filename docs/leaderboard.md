...
**3879 verified proofs · 3571 attributed · 308 historical/unknown · 1184 logged terminal runs.**
...
| Proofs with run telemetry | 842 (21.7%) |

## Work Queue

**3906 goals · 2199 archived · 3 blocked · 11 open · 1684 proved · 9 translated.**
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 191 | 144 | 47 | 332 | 22.0% | 287 | 2096.1 | 243085 |
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 1897 | 1896 | 1 | 704 | 100.0% | 1900 | 0.0 | 237425 |
| 3 | [@chat-bit-01](https://github.com/chat-bit-01) | 1494 | 1247 | 247 | 0 | — | 1827 | 18.0 | 221850 |
...
**3571 explicit solver credits · 308 inferred git credits · 0 uncredited proof records.**

Git add-author attribution covers 3879 of 3879 proof index files. It is used only where explicit `solver≜` provenance is missing.
