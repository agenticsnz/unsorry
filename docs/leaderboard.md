...
**4749 verified proofs · 4440 attributed · 309 historical/unknown · 450 logged terminal runs.**
...
| Run success rate | 19.1% |
| Provider attempts | 576 |
| Failed attempts | 490 |
| Attempt yield | 14.9% |
| Recorded run time | 122h 37m |
| Median / p90 run time | 8m 0s / 32m 6s |
| Verified successes per recorded hour | 0.70 |
| Proofs with run telemetry | 86 (1.8%) |

## Work Queue

**5011 goals · 3389 archived · 16 blocked · 225 open · 1372 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 225 | 67 | 29.8% | 233 | 7m 26s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 286 | 5.2% | 216 | 2896.2 | 314220 |
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 2365 | 2364 | 1 | 44 | 100.0% | 2368 | 0.0 | 295925 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2363 | 44 | 100.0% | 0 | 1 | 0s | — |
