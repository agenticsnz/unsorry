...
**4669 verified proofs · 4360 attributed · 309 historical/unknown · 547 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 183 |
| Failed terminal runs | 364 |
| Decomposed after failure | 33 |
| Failed without decomposition | 331 |
| Run success rate | 33.5% |
| Provider attempts | 673 |
| Failed attempts | 490 |
| Attempt yield | 27.2% |
| Recorded run time | 122h 37m |
| Median / p90 run time | 5m 37s / 32m 4s |
| Verified successes per recorded hour | 1.49 |
| Proofs with run telemetry | 183 (3.9%) |

## Work Queue

**4931 goals · 3185 archived · 16 blocked · 225 open · 1496 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 322 | 164 | 50.9% | 233 | 3m 51s |
...
|-----:|-------------|-------------:|---------:|---------:|-----:|------------:|------------------:|------------------:|------:|
| 1 | [@cgbarlow](https://github.com/cgbarlow) | 120 | 73 | 47 | 286 | 5.2% | 216 | 2824.2 | 307020 |
| 2 | [@chat-bit-01](https://github.com/chat-bit-01) | 2023 | 1776 | 247 | 4 | 100.0% | 2354 | 20.7 | 288045 |
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2285 | 2284 | 1 | 141 | 100.0% | 2288 | 0.0 | 285925 |
...
**4360 explicit solver credits · 308 inferred git credits · 1 uncredited proof records.**

Git add-author attribution covers 4669 of 4669 proof index files. It is used only where explicit `solver≜` provenance is missing.

## Providers and Models

| Provider / model | Verified proofs | Runs | Run success | Failed attempts | Solvers | Median time | Successes / recorded hour |
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2283 | 141 | 100.0% | 0 | 1 | 0s | — |
