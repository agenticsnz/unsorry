...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 589 logged terminal runs.**
...
| Provider attempts | 713 |
| Failed attempts | 487 |
| Attempt yield | 31.7% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 4m 50s / 32m 1s |
| Verified successes per recorded hour | 1.87 |
| Proofs with run telemetry | 226 (4.9%) |

## Work Queue

**4870 goals · 3083 archived · 15 blocked · 224 open · 1539 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 364 | 207 | 56.9% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 184 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 184 | 100.0% | 0 | 1 | 0s | — |
