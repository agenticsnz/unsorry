...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 725 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 362 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 49.9% |
| Provider attempts | 849 |
| Failed attempts | 487 |
| Attempt yield | 42.6% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 3m 18s / 31m 54s |
| Verified successes per recorded hour | 2.99 |
| Proofs with run telemetry | 362 (7.8%) |

## Work Queue

**4870 goals · 2947 archived · 15 blocked · 224 open · 1675 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 500 | 343 | 68.6% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 320 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 320 | 100.0% | 0 | 1 | 0s | — |
