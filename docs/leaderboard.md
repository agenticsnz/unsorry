...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 555 logged terminal runs.**
...
| Median / p90 run time | 5m 26s / 32m 2s |
| Verified successes per recorded hour | 1.59 |
| Proofs with run telemetry | 192 (4.2%) |

## Work Queue

**4870 goals · 3117 archived · 15 blocked · 224 open · 1505 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 330 | 173 | 52.4% | 230 | 3m 33s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 150 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 150 | 100.0% | 0 | 1 | 0s | — |
