...
**4610 verified proofs · 4302 attributed · 308 historical/unknown · 759 logged terminal runs.**

## Efficiency Baseline

| Metric | Value |
|--------|------:|
| Successful terminal runs | 396 |
| Failed terminal runs | 363 |
| Decomposed after failure | 32 |
| Failed without decomposition | 331 |
| Run success rate | 52.2% |
| Provider attempts | 883 |
| Failed attempts | 487 |
| Attempt yield | 44.9% |
| Recorded run time | 121h 4m |
| Median / p90 run time | 2m 56s / 31m 51s |
| Verified successes per recorded hour | 3.27 |
| Proofs with run telemetry | 396 (8.6%) |

## Work Queue

**4870 goals · 2913 archived · 15 blocked · 224 open · 1709 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 534 | 377 | 70.6% | 230 | 0s |
...
| 3 | [@ohdearquant](https://github.com/ohdearquant) | 2227 | 2226 | 1 | 354 | 100.0% | 2230 | 0.0 | 278675 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2225 | 354 | 100.0% | 0 | 1 | 0s | — |
