...
**4705 verified proofs · 4396 attributed · 309 historical/unknown · 515 logged terminal runs.**
...
| Provider attempts | 641 |
| Failed attempts | 490 |
| Attempt yield | 23.6% |
| Recorded run time | 122h 37m |
| Median / p90 run time | 6m 34s / 32m 5s |
| Verified successes per recorded hour | 1.23 |
| Proofs with run telemetry | 151 (3.2%) |

## Work Queue

**4967 goals · 3253 archived · 16 blocked · 225 open · 1464 proved · 9 translated.**

## Efficiency by Difficulty

| Difficulty | Runs | Successes | Run success | Failed attempts | Median time |
|-----------:|-----:|----------:|------------:|----------------:|------------:|
| 1 | 290 | 132 | 45.5% | 233 | 4m 42s |
...
| 2 | [@ohdearquant](https://github.com/ohdearquant) | 2321 | 2320 | 1 | 109 | 100.0% | 2324 | 0.0 | 290425 |
...
|------------------|----------------:|-----:|------------:|----------------:|--------:|------------:|-------------------------:|
| `python / sympy` | 2319 | 109 | 100.0% | 0 | 1 | 0s | — |
